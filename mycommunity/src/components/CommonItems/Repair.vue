<template>
  <div>
    <v-card>
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn color="info" @click="repair_dialog=true">立刻报修</v-btn>
      </v-card-actions>
    </v-card>
    ...
    <!-- 服务dialog -->
    <v-dialog v-model="repair_dialog" persistent max-width="600px">
      <v-card>
        <v-card-title>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" flat @click="repair_dialog=false">关闭</v-btn>

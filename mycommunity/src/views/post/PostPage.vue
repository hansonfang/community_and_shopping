      ...
      <v-layout row>
        <v-flex xs12>
          <div class="v-card d-f align-center">
            <v-chip v-if="isBest" color="red" small dark>精品贴</v-chip>
            <h3 style>{{title}}</h3>
            <v-spacer></v-spacer>
...
export default {
  ...
  data() {
    return {
      id: "",
      title: "马上要去美国出差了，飞机上可以带安眠药和抗抑郁药吗？",
      isBest: true,
      msg:
      ...
      details: [
        ...
        {
          avatar: "https://picsum.photos/180/180/?random",
          name: "秋天的吴彦祖",
          hasFollow: true,
          msg: "在故宫附近的煎饼果子非常好吃，下次还会再去的",
          floor: 2,
          dateTime: "2019-02-27 20:51",
          replys: [
            {
              name: "小太阳",
              dateTime: "2019-02-27 20:52",
              to: "秋天的吴彦祖",
              msg:"是门口的老大爷卖的吗"
            },
            { name: "阿凯", dateTime: "2019-02-27 20:55", to: "小太阳",msg:"对,那个大爷卖了好多年了" },
            {
              name:"秋天的吴彦祖",
              dateTime:"2019-02-27 21:10",
              to:"小太阳",
              msg:"是啊，是他卖的"
            }
          ]

<template>
  <v-container class="max-width">
    ...
    <v-layout row>
      <h3 class="sel-none">
        <v-icon color="green lighten-1">fa-list-ul</v-icon>
        投票选项
      </h3>
    </v-layout>
    <v-layout
    ...
    >
      <v-flex
        xs2
        class="d-flex align-center justify-end subheading pr-4"
      >{{item.index}}</v-flex>
      <v-flex xs10>
        <v-text-field
          v-model="item.text"
